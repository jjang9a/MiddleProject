<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
 <div class="container-fluid bg-dark text-light footer wow fadeIn" data-wow-delay="0.1s" style="margin-top:100px; padding-top: 0;" >
            <div class="container pb-5">
                <div class="row g-5" style="padding-left:500px">
